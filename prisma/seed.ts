...
async function main() {
  ...
  const items: ItemSeed[] = [
    ...
    { cat: "Starters", name: "Veg Seekh Kebab", desc: "Smoky vegetable kebabs, seared on the tawa.", emoji: "🥖", price: 229, vegan: true, prep: 25 },
    ...
    { cat: "Breads", name: "Butter Tawa Roti", desc: "Whole-wheat, brushed with white butter.", emoji: "🫓", price: 25, prep: 8, all: "Gluten, dairy" },
